...
<body class="flex items-center justify-center min-h-screen bg-gray-100">
  <div id="card" class="w-full max-w-md p-6 bg-white rounded-lg shadow-lg">
    <h2 class="text-2xl font-bold text-gray-800 mb-4">Updated Successfully</h2>
    <a href="customerprofile" class="px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700 transition">Back To My Profile</a>
  </div>
